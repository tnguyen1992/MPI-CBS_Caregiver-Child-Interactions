...
map(2,1) = data.coherences(1, column);                                      % insert the sensor data into the map  
map(1,2) = data.coherences(2, column);
map(3,2) = data.coherences(3, column);
map(2,3) = data.coherences(4, column);

map(6,1) = data.coherences(5, column);
map(5,2) = data.coherences(6, column);
map(7,2) = data.coherences(7, column);
map(6,3) = data.coherences(8, column);

map(2,5) = data.coherences(9, column);
map(1,6) = data.coherences(10, column);
map(3,6) = data.coherences(11, column);
map(2,7) = data.coherences(12, column);

map(6,5) = data.coherences(13, column);
map(5,6) = data.coherences(14, column);
map(7,6) = data.coherences(15, column);
map(6,7) = data.coherences(16, column);

map(1,1) = (data.coherences(1, column) + data.coherences(2, column)) / 2;   % interpolate neigbours of sensors
map(3,1) = (data.coherences(1, column) + data.coherences(3, column)) / 2;
map(1,3) = (data.coherences(2, column) + data.coherences(4, column)) / 2;
map(3,3) = (data.coherences(3, column) + data.coherences(4, column)) / 2;

map(5,1) = (data.coherences(5, column) + data.coherences(6, column)) / 2;
map(7,1) = (data.coherences(5, column) + data.coherences(7, column)) / 2;
map(5,3) = (data.coherences(6, column) + data.coherences(8, column)) / 2;
map(7,3) = (data.coherences(7, column) + data.coherences(8, column)) / 2;

map(1,5) = (data.coherences(9, column) + data.coherences(10, column)) / 2;
map(3,5) = (data.coherences(9, column) +  data.coherences(11, column)) / 2;
map(1,7) = (data.coherences(10, column) + data.coherences(12, column)) / 2;
map(3,7) = (data.coherences(11, column) + data.coherences(12, column)) / 2;

map(5,5) = (data.coherences(13, column) + data.coherences(14, column)) / 2;
map(7,5) = (data.coherences(13, column) + data.coherences(15, column)) / 2;
map(5,7) = (data.coherences(14, column) + data.coherences(16, column)) / 2;
map(7,7) = (data.coherences(15, column) + data.coherences(16, column)) / 2;

map(2,2) = (data.coherences(1, column) + data.coherences(2, column) ... 
            +data.coherences(3, column)+data.coherences(2, column)) ...
            / 4;
map(6,2) = (data.coherences(5, column) + data.coherences(6, column) ...
            +data.coherences(7, column)+data.coherences(8, column)) ...
            / 4;
map(2,6) = (data.coherences(9, column) + data.coherences(10, column) ...
